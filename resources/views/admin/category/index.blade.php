                ...
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    @forelse($categories as $no =>$category)
                                        <tr>
                                            ...
                                            <td>{{ $category->name }}</td>
                                            <td class="text-center">
                                                <a href="{{ route('admin.category.edit', $category->id) }}" class="btn btn-sm btn-green mb-1">
                                                    <i class="fa fa-pencil-alt"></i>
                                                </a>
                                                <button onClick="Delete(this.id)" class="btn btn-sm btn-red mb-1" id="{{ $category->id }}">
                            ...
                            <div style="text-align: center">{{ $categories->links('vendor.pagination.bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
