            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ url('user/two-factor-authentication') }}">
                        ...
                        <button type="submit" class="btn btn-red mb-3 text-uppercase">
                            Disable Two-Factor
                        </button>
                    </form>
                    ...
                    <form method="POST" action="{{ url('user/two-factor-recovery-codes') }}">
                        ...
                        <button type="submit" class="btn btn-gray text-uppercase">
            ...
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user-profile-information.update') }}">
                        ...
                        <div class="form-group">
                            <button class="btn btn-green text-uppercase" type="submit">
                                Update Profile
                            </button>
                        </div>
                    </form>
